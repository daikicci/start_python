...
# Тут поэкспериментировала с валидацией, т.к. не очень нравится, что чуть только юзер вводит что-то не то, валимся с
# ошибкой, вместо того чтобы это обработать
try:
